...
export const Video = () => {
  ...
  useEffect(() => {
    if (id) {
      ...
      const getCommentsQuery = query(collection(db, 'videos', id, 'comments'));
  ...
  return (
    <div className='py-20 px-10 bg-yt-black flex flex-row h-full'>
      <div className='left flex-1'>
        ...
        <h2 className='text-yt-white font-semibold mt-3 mb-1 text-lg'>{data?.name}</h2>
        <div className='flex'>
          <div className='flex items-center'>
            <img src={data?.logo} alt={data?.name} className='w-10 h-10 rounded-full' />
            <div className='px-3'>
            ...
            <div className='flex pl-28'>
              ...
              <div className='flex bg-yt-lightblack items-center rounded-2xl h-10 mx-1 cursor-pointer hover:bg-yt-light-1'>
                <div className='flex px-3 items-center cursor-pointer'>
                  ...
                  <p className='text-yt-white pl-2 pr-3 text-lg font-semibold'>share</p>
                </div>
              </div>
              <div className='flex bg-yt-lightblack items-center rounded-2xl h-10 mx-1 cursor-pointer hover:bg-yt-light-1'>
                <div className='flex px-3 items-center cursor-pointer'>
